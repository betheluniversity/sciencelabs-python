...
class SessionView(FlaskView):
    ...
    def save_student_edits(self, session_id):
        ...
        try:
            ...
            strrr = "ss_id: {0} --- time_in: {1} --- time_out: {2} --- other_course: {3} --- student_courses: {4} --- virtual: {5}".format(student_session_id, time_in, time_out, other_course, student_courses, virtual)
